...
import com.whatshouldeat.study.search.Channel;
import com.whatshouldeat.study.search.SearchDTO;
import com.whatshouldeat.study.searchImg.ImgChannel;
...
public class MySerachImgApiUtils {
    ...
    public List<SearchImgVO> searchPlace(String keyword){
        ...
        String apiURL = "https://openapi.naver.com/v1/search/image.json?query="+keyword+"&display=20&start=1&sort=sim&filter=medium";    // json 결과
